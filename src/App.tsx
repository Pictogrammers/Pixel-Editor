      ...
      <div className="toolbar-horizontal">
        ...
        <section>
          ...
          <button onClick={handleExport}>
            <svg viewBox="0 0 48 48">
              <path fill="currentColor" d="M22 37V35H20V33H18V31H16V29H14V27H12V24H18V12H19V11H29V12H30V24H36V27H34V29H32V31H30V33H28V35H26V37H22M27 26V14H21V26H20V27H17V28H19V30H21V32H23V34H25V32H27V30H29V28H31V27H28V26H27Z" />
            </svg>
          </button>
        </section>
        <section>
